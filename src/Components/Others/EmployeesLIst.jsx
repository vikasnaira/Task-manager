    ...
    return (
      <div className=' h-[80vh] overflow-scroll'>
              <div className='flex w-full justify-between sticky top-0 bg-gray-200'>
                ...
                <button className='bg-blue-500 text-white rounded-3xl flex h-fit md:p-2 px-2 py-1 m-2 md:m-0 text-sm items-center gap-1 md:gap-3'
            ...
            <div className=''>
              {clients.map((client)=>(
                ...
                <div className="info w-full " key={client.id}>
